...
const APIControler = (function(){
    ...
    const _getToken = async () =>{
        ...
        const result = await fetch("https://accounts.spotify.com/api/8c4f2385a3214855b69bd2007242cb04",{
            method: 'POST',
            headers: {
    ...
    return{
        ...
        inputField(){
            return{
                ...
                playlists: document.querySelector(DOMElements.selectPlaylist),
        ...
        createSongDetail(img, title, artist){
            ...
            const html ='<div class="row col-sm-12 px-0"><img src="${img}" alt=""></div><div class="row col-sm-12 px-0"><label for="Genre" class="form-label col-sm-12">${title}:</label></div><div class="row col-sm-12 px-0"><label for="Genre" class="form-label col-sm-12">By ${artist}:</label></div>';
